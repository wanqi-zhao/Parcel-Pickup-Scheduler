    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="relative w-[390px] min-h-[844px] bg-white px-[14px] pt-[10px] pb-[110px] flex flex-col">
        ...
        <div className="mt-[18px] text-center">
          <h1 className="text-[22px] font-medium tracking-[0.3px] text-[#333333]">
            TRACKING
          </h1>
        </div>
        ...
        <div className="mt-[18px] rounded-[8px] border border-[#d4d4d4] bg-white px-[12px] py-[10px]">
          ...
          <p className="mt-[6px] text-[20px] font-medium text-[#43c25c]">
            {trackingData.status}
          </p>
        </div>
        ...
        <div className="mt-[8px] overflow-hidden rounded-[8px] border border-[#d4d4d4] bg-white">
          ...
          {trackingData.history.map((item, index) => (
            ...
            >
              <p className="text-[20px] font-medium leading-[1.15] text-[#333333]">
                {item.title}
              </p>
              <p className="mt-[4px] text-[18px] leading-[1.2] text-[#a6a6a6]">
                {item.location}
              </p>
              <p className="mt-[4px] text-[18px] leading-[1.2] text-[#a6a6a6]">
                {item.time}
