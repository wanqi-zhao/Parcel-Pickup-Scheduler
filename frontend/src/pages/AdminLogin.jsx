      ...
      <div className="w-[390px] min-h-[844px] bg-white px-[18px] pt-[10px] pb-[24px] flex flex-col">
        ...
        >
          <svg width="10" height="16" viewBox="0 0 10 16" fill="none">
            <path d="M8 2L2 8L8 14" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <span>Back</span>
        </button>

        <div className="mt-[56px] text-center">
          <h1 className="text-[34px] font-bold leading-[1.02] tracking-[-0.5px] text-black">Welcome</h1>
          <h2 className="text-[34px] font-bold leading-[1.02] tracking-[-0.5px] text-black">back to our team</h2>
        </div>
